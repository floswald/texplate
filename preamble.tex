...
\newcommand{\plength}{2}  % presentation length
% plengths:
% 1: short - 20mins
% 2: 60 mins
% 3: 75 mins
\ifthenelse{\plength = 1}{
    \includeversion{shortv}
    \excludeversion{longv}
    \excludeversion{onehour}
}{
    \ifthenelse{\plength = 2}{
        \includeversion{onehour}
        \includeversion{shortv}
        \excludeversion{longv}
    }{
        \includeversion{onehour}
...
\newcommand{\db}{${HOME}/Dropbox/research/bankruptcy/WL-CM-FO/current}
